    ...
    return (
        ...
        <div className="flex justify-center py-20 sm:py-20 lg:py-56">
            <div className="max-w-lg text-center">
                ...
                <a href="https://github.com/ashaza13" target="_blank"><button ref={glitchButton.ref} className="bg-white text-black center px-8 py-2 mt-8 transition hover:bg-black hover:text-white">View My Work</button></a>
            </div>
        </div>
    )
};
