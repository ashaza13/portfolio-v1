    ...
    return (
        <div className="flex justify-center py-20 sm:py-20 lg:py-56">
            <div className="max-w-lg text-center">
                ...
                <button className="bg-white text-black center px-8 py-2 mt-8 transition hover:bg-black hover:text-white hover:-translate-x-2 hover:-translate-y-2">View My Work</button>
            </div>
        </div>
    )
};
