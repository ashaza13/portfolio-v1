    ...
    return (
        ...
        <div className="flex justify-center mx-16 py-44 md:py-60">
            <div className="max-w-lg text-center">
                ...
                <p className="text-white text-left py-2 animate-fadeIn">I'm a Software Engineer Analyst at Accenture Federal Services. Check out my work below and get to know me through this site!</p>
