...
const navigation = [
  { number: '01.', name: 'About', href: '#', current: true, linkUrl: "/" },
  { number: '02.', name: 'Experience', href: '#', current: false, linkUrl: "/search" },
  { number: '03.', name: 'Work', href: '#', current: false, linkUrl: "/profile" },
  { number: '04.', name: 'Contact', href: '#', current: false, linkUrl: "/contact" },
]
      ...
      <Dialog as="div" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        <Dialog.Panel className="fixed inset-0 z-10 overflow-y-auto px-6 py-6 lg:hidden">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5 text-white text-xl">
              A
            </a>
            <button
              type="button"
