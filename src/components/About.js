    ...
    return (
        <div className="flex justify-center py-32 sm:py-32 lg:py-32">
            <div className="max-w-lg text-left">
                ...
                <p className="text-white py-4">I am very passionate about Computer Science. I have worked on and continue to work on many projects to expand my knowledge. Recently, I joined the <a href="https://eng.vt.edu/academics/student-teams/hevt.html" className="group text-orange-600 transition duration-300">Hokie Electric Vehicle Team<span className="inline-block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-orange-600"></span></a> creating MATLAB simulations utilizing machine learning tools such as TensorFlow.</p>
